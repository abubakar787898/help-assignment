...
@section('content')
    <div class="container-fluid">
        <div class="block-header">
            <a class="btn btn-primary waves-effect" href="{{ route('admin.posts.create') }}">
                                    ...
                                    @foreach($posts as $key=>$post)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('admin.posts.show',$post->id) }}" class="btn btn-info waves-effect">
                                                    <i class="material-icons">visibility</i>
                                                </a>
                                                <a href="{{ route('admin.posts.edit',$post->id) }}" class="btn btn-info waves-effect">
